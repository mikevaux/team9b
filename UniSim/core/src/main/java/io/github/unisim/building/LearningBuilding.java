...
public class LearningBuilding extends Building {
   ...
   */
  public LearningBuilding(Texture texture, float textureScale, Vector2 textureOffset, Point location, Point size, Boolean flipped, String name) {
    super(texture, textureScale, textureOffset, location, size, flipped, name);
    this.type = BuildingType.LEARNING;
  }
}
